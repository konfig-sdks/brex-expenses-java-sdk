...
/**
 * API tests for ReceiptMatchApi
 */
@Disabled
public class ReceiptMatchApiTest {

    private static ReceiptMatchApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ReceiptMatchApi(apiClient);
    }
     ...
     */
    @Test
    public void createNewReceiptMatchTest() throws ApiException {
        String receiptName = null;
        CreateAsyncFileUploadResponse response = api.createNewReceiptMatch(receiptName)
                .execute();
