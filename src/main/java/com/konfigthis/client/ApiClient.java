...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://platform.brexapis.com";
    private String tokenUrl = "https://accounts-api.brex.com/oauth2/default/v1/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://platform.brexapis.com)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://accounts-api.brex.com/oauth2/default/v1/token)
     * @return An instance of OkHttpClient
     */
